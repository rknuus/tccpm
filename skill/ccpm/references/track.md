...
**Trigger**: "list Initiatives", "what Initiatives do we have", "show backlog"

```bash
bash references/scripts/initiative-list.sh
```
...
**Trigger**: "Initiative status", "which Initiatives are parsed", "what's in backlog"

```bash
bash references/scripts/initiative-status.sh
```
...
Searches local task files, Initiatives, and epics for the query term.
